grid_items:
  ...
  -
    ...
    row-end: 16
    column-end: 15
    image: /assets/grid/web-20-21_sint-lukas.png
  -
    type: grid_image
    column-start: 1
    row-start: 12
...
inschrijvingen__text: |
  <p>Je kan een plaatsje reserveren via dit online formulier: <a class="typeform-share link" href="https://friendlyinternet.typeform.com/to/Z2U4Ad" data-mode="drawer_right" style="color:#191919;text-decoration:underline;font-size:17px;" data-hide-headers="true" data-hide-footer="true" target="_blank">Inschrijvingsformulier </a>
  </p> (function() { var qs,js,q,s,d=document, gi=d.getElementById, ce=d.createElement, gt=d.getElementsByTagName, id="typef_orm_share", b="https://embed.typeform.com/"; if(!gi.call(d,id)){ js=ce.call(d,"script"); js.id=id; js.src=b+"embed.js"; q=gt.call(d,"script")[0]; q.parentNode.insertBefore(js,q) } })()</script>
